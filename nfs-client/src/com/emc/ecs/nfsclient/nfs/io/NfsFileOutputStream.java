...
public class NfsFileOutputStream extends OutputStream {
	 ...
	 * The usual logger.
	 */
	private static final Logger LOG = Logger.getLogger(NfsFileOutputStream.class.getName());
	...
	/**
	 * The current value of the file offset to which we have written data. This is
	 * advanced after each write.
	 */
	 ...
	 * <li>DATA_SYNC = 1 - Commit all data to stable storage, plus enough metadata
	 * for retrieval, before returning.</li>
	 ...
	 * specified <code>NfsFile</code> object, starting at <code>offset = 0</code>
	 * and using <code>syncType = FILE_SYNC</code> (commit all data and metadata to
	 * stable storage before returning).
	 * <p>
	 * If the file does not exist, it will first be created.
	 *
	 * @param nfsFile The file to be opened for writing.
	 ...
	 *
	 * @param nfsFile  The file to be opened for writing.
	 * @param syncType One of the values below.
	 *                 <ul>
	 *                 <li>UNSTABLE = 0 - Best effort, no promises.</li>
	...
	/**
	 * Creates a file output stream to write to the file represented by the
	 * specified <code>NfsFile</code> object, starting at <code>offset</code> and
	 * using <code>syncType</code> behavior.
	 * <p>
	 * If the file does not exist, it will first be created.
	 *
	 * @param nfsFile  The file to be opened for writing.
	 * @param offset   Where to start writing to the file.
	 * @param syncType One of the values below.
	 *                 <ul>
	 *                 <li>UNSTABLE = 0 - Best effort, no promises.</li>
	 *                 <li>DATA_SYNC = 1 - Commit all data to stable storage, plus
	...
	/**
	 * @return The number of bytes that can be written to the buffer before overflow
	 *         occurs.
	 */
