...
public class ClientIOHandler extends SimpleChannelHandler {
   ...
   // private static final Logger LOG = LoggerFactory.getLogger(ClientIOHandler.class);
    private static final Logger LOG = Logger.getLogger(ClientIOHandler.class.getName());
    ...
    private void closeConnection(String messageStart) {
        LOG.warning(messageStart + ": "+ getRemoteAddress());
        _connection.close();
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) throws Exception {
        ...
        LOG.warning("Exception on connection to " + getRemoteAddress() +" "+ e.getCause());
