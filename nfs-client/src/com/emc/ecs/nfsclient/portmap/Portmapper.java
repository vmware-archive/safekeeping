...
public class Portmapper {
	...
	/**
	 * @return the _usePrivilegedPort
	 */
    public static boolean isUsePrivilegedPort() {
		return _usePrivilegedPort;
	}

	/**
	 * @param _usePrivilegedPort the _usePrivilegedPort to set
	 */
	public static void setUsePrivilegedPort(boolean _usePrivilegedPort) {
		Portmapper._usePrivilegedPort = _usePrivilegedPort;
	}
