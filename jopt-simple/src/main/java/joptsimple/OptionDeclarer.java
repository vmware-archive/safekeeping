...
/**
 * Trains the option parser. This interface aids integration that disposes
 * declaration of options but not actual command-line parsing.
 *
 * Typical use is for another class to implement {@code OptionDeclarer} as a
 * facade, forwarding calls to an {@code OptionParser} instance.
 *
 * Note that although this is an interface, the returned values of calls are
 * concrete jopt-simple classes.
 *
...
public interface OptionDeclarer {
	 ...
	 *                    used when generating help information about the parser.
	 * @return an object that can be used to flesh out more detail about the options
	 * @throws OptionException          if any of the options contain illegal
	 *                                  characters
	 ...
	 *
	 * <p>
	 * If not called, then the parser raises an {@link OptionException} when it
	...
	/**
	 * Gives an object that represents an access point for non-option arguments on a
	 * command line.
	 *
	 ...
	 *
	 * @see #nonOptions()
	 * @param description a string that describes the purpose of the non-option
	 *                    arguments. This is used when generating help information
	 *                    about the parser.
	 * @return an object that can be used to flesh out more detail about the
	 *         non-option arguments
	 */
