...
public class ConnectApiServiceImpl extends ConnectApiService implements Runnable {
	...
	this.connectionManager = GlobalState.precheck(securityContext).getConnection();
