...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2022-08-31T19:06:45.540Z[GMT]")public class RestoreApiServiceImpl extends RestoreApiService {
    @Override
    public Response restore(RestoreOptions body, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
