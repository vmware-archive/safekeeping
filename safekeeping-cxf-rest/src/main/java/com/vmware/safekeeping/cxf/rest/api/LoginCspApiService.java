...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2022-08-31T19:06:45.540Z[GMT]")public abstract class LoginCspApiService {
    public abstract Response loginCsp(CspConnectOptions body,SecurityContext securityContext) throws NotFoundException;
}
