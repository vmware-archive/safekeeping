...
/**
 * Gets or Sets VirtualBackupDiskPhases
 */
public enum VirtualBackupDiskPhases {
  ...
  VirtualBackupDiskPhases(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static VirtualBackupDiskPhases fromValue(String text) {
    for (VirtualBackupDiskPhases b : VirtualBackupDiskPhases.values()) {
