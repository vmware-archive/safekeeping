...
import com.vmware.safekeeping.cxf.rest.api.factories.StatusArchiveApiServiceFactory;
...
import com.vmware.safekeeping.cxf.rest.model.ArchiveStatusOptions;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2022-09-06T22:00:47.492Z[GMT]")public class StatusArchiveApi  {
   ...
   public StatusArchiveApi(@Context ServletConfig servletContext) {
      StatusArchiveApiService delegate = null;

      if (servletContext != null) {
         String implClass = servletContext.getInitParameter("StatusArchiveApi.implementation");
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (StatusArchiveApiService) Class.forName(implClass).newInstance();
            } catch (Exception e) {
      ...
      if (delegate == null) {
         delegate = StatusArchiveApiServiceFactory.getStatusArchiveApi();
      }
    ...
    @Operation(summary = "status  Archive", description = "statusArchive ", security = {
    ...
    public Response statusArchive(@Parameter(in = ParameterIn.DEFAULT, description = "Check Generations  options" ,required=true) ArchiveStatusOptions body

,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.statusArchive(body,securityContext);
    }
}
